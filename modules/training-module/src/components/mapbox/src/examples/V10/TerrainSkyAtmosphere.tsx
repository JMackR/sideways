...
import { MapView, SkyLayer, Logger, Terrain, RasterDemSource, Atmosphere, Camera } from '@rnmapbox/maps';
...
const TerrainSkyAtmosphere = () => {
  ...
  return (
    <>
      ...
      />
      <MapView style={{ flex: 1 }} styleURL={'mapbox://styles/mapbox-map-design/ckhqrf2tz0dt119ny6azh975y'}>
        <Camera
          ref={cameraRef}
          centerCoordinate={[
            // -74.00597, 40.71427
