...
import { MapView, Images, Camera, Image, SymbolLayer, ShapeSource } from '@rnmapbox/maps';
...
const styles = {
  icon: {
    ...
    iconSize: ['match', ['get', 'icon'], 'example', 1.2, 'airport-15', 1.2, /* default */ 1],
        ...
        >
          <Image name="pin-rn">
            <View>
              ...
              >
                <Text style={{ fontWeight: 'bold', color: 'white' }}>RN Pin 3</Text>
              </View>
            </View>
          </Image>
        </Images>
