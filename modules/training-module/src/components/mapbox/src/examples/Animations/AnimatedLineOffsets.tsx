...
import { Camera, Logger, MapView, ShapeSource, __experimental, LineLayer } from '@rnmapbox/maps';
...
const AnimatedLineOffsets = memo(() => {
  ...
  }, [startOffsetState, endOffsetState, durationState, lineLength, animator, buildRandomizedLine]);

  return (
    <>
      <MapView style={{ flex: 1 }}>
        <Camera defaultSettings={{ bounds }} bounds={bounds} animationDuration={1000} />
