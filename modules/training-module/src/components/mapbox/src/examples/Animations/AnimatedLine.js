  ...
  constructor(props) {
    ...
    this.state = {
      ...
      shape: new AnimatedCoordinatesArray(
        [...Array(steps).keys()].map((v, i) => [lon + delta * (i / steps) * (i / steps), lat + (delta * i) / steps]),
      ),
      targetPoint: {
    ...
    return (
      <Page {...this.props}>
        ...
        >
          ...
          >
            <Animated.CircleLayer id="currentLocationCircle" style={styles.circleLayer} />
          </Animated.ShapeSource>
        ...
        <Bubble>
          <Button title="Animate a lot of points" onPress={() => this.startAnimate()} />
          <Button title="Animate a few points with abort" onPress={() => this.startAnimateFewPointsWithAbort()} />
          <Button title="Animate route/morphing" onPress={() => this.startAnimateMorphingRoute()} />
          <Button title="Animate route" onPress={() => this.startAnimateRoute()} />
        </Bubble>
      </Page>
    );
  }
