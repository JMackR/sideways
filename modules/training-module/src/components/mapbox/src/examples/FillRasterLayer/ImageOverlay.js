...
class ImageOverlay extends React.Component {
  ...
  render() {
    ...
    return (
      <>
        <Mapbox.MapView ref={(ref) => (this.map = ref)} style={sheet.matchParent} styleURL={Mapbox.StyleURL.Satellite}>
          <Mapbox.Camera defaultSettings={{ zoomLevel: 4, centerCoordinate: [-79, 40] }} />
