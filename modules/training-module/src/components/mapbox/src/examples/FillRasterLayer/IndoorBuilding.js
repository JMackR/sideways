    ...
    return (
      <>
        <Mapbox.MapView ref={(ref) => (this.map = ref)} style={sheet.matchParent}>
          <Mapbox.Camera zoomLevel={16} pitch={40} heading={20} centerCoordinate={[-87.61694, 41.86625]} />

          <Mapbox.Light style={{ position: [5, 90, this.state.sliderValue] }} />

          <Mapbox.ShapeSource id="indoorBuildingSource" shape={indoorMapGeoJSON}>
            <Mapbox.FillExtrusionLayer id="building3d" style={layerStyles.building} />
          </Mapbox.ShapeSource>
        </Mapbox.MapView>
