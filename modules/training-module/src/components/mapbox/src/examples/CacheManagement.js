...
class CacheManagement extends React.Component {
  ...
  render() {
    ...
    const buttonStyles = validSizeValue ? styles.button : [styles.button, { backgroundColor: 'grey' }];
        ...
        <View style={styles.controls}>
          <View style={styles.controlsContainer}>
            <View style={styles.control}>
              <TouchableOpacity onPress={this.invalidateAmbientCache} style={styles.button}>
                <Text style={styles.buttonTxt}>Invalidate cache</Text>
              </TouchableOpacity>
            </View>

            <View style={styles.control}>
              <TouchableOpacity onPress={this.resetDatabase} style={styles.button}>
            ...
            <View style={styles.control}>
              <TouchableOpacity onPress={this.clearAmbientCache} style={styles.button}>
