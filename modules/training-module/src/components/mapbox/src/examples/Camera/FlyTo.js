...
const layerStyles = {
  building: {
    ...
    fillExtrusionHeight: ['interpolate', ['linear'], ['zoom'], 15, 0, 15.05, ['get', 'height']],

    fillExtrusionBase: ['interpolate', ['linear'], ['zoom'], 15, 0, 15.05, ['get', 'min_height']],
        ...
        <Mapbox.MapView style={styles.matchParent}>
          ...
          {Platform.OS !== 'web' && (
            <>
              ...
              <Mapbox.FillExtrusionLayer id="building3d" sourceLayerID="building" style={layerStyles.building} />
            </>
          )}
        </Mapbox.MapView>
      </>
