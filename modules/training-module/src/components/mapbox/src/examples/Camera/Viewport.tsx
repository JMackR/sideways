...
import { MapView, Viewport, NativeUserLocation, ShapeSource, CircleLayer } from '@rnmapbox/maps';
  ...
  return (
    <>
      ...
      <MapView style={styles.matchParent}>
        <Viewport
          ref={viewport}
          onStatusChanged={(event: object) => console.log(' => Viewport native event:', event, typeof event)}
        />
        <NativeUserLocation />
