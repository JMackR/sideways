...
const RestrictMapBounds = (props) => (
  <Page {...props}>
    <MapboxGL.MapView style={sheet.matchParent} styleURL={MapboxGL.StyleURL.SatelliteStreet}>
      <MapboxGL.Camera maxBounds={bounds} zoomLevel={7} centerCoordinate={[-4.744276, 50.361239]} />
