...
import { Camera, FillLayer, MapView, ShapeSource, StyleURL } from '@rnmapbox/maps';
...
const DynamicUrl = () => {
  ...
  return (
    <>
      <MapView styleURL={StyleURL.Satellite} style={styles.matchParent} testID={'dynamic-url'}>
        <Camera
          defaultSettings={{
