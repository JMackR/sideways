...
const OrnamentButtons = ({
  ...
  <>
    <Button title={'Visiblity: ' + visibility[ornamentType]} onPress={(): void => onPressVisibility(ornamentType)} />
    <Button title={'Position: ' + position[ornamentType]} onPress={(): void => onPressPosition(ornamentType)} />
  </>
);
...
const Ornaments = () => {
  ...
  const [compassFadeWhenNorth, setCompassFadeWhenNorth] = useState<boolean | undefined>(undefined);
