...
import { Alert, Text, View, Button, TouchableOpacity, Dimensions, StyleSheet } from 'react-native';
...
class CreateOfflineRegion extends React.Component {
  ...
  onCreate() {
    // start download
    offlineManager.createPack(this.options, this.onDownloadProgress, this.errorListener);
  }
