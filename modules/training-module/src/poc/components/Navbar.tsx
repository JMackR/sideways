...
const Navbar = (props: { navigation: any }) => {
  ...
  return (
    <View style={styles.navbar}>
      ...
      >
        <FontAwesomeIcon style={styles.text} icon={faHome} size={20} />

        <Text style={[styles.text, { marginTop: '2%' }]}>Home</Text>
      </TouchableOpacity>
      ...
      >
        <FontAwesomeIcon style={styles.text} icon={faChartBar} size={20} />

        <Text style={[styles.text, { marginTop: '2%' }]}>Stats</Text>
      </TouchableOpacity>
      ...
      >
        <FontAwesomeIcon icon={faStopwatch} size={20} style={styles.text} />

        <Text style={[styles.text, { marginTop: '2%' }]}>Tracking</Text>
      </TouchableOpacity>
      ...
      >
        <FontAwesomeIcon icon={faMap} size={20} style={styles.text} />

        <Text style={[styles.text, { marginTop: '2%' }]}>Map</Text>
      </TouchableOpacity>
    </View>
  );
};
