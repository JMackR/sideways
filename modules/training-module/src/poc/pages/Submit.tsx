...
const Submit = ({ navigation }: any) => {
  ...
  return (
    <Wrapper navigation={navigation} title={'Overview'}>
      <View style={{ height: '79.3%', paddingHorizontal: '3%' }}>
        <View style={styles.root}>
          <Image style={styles.story} source={require('../resources/img/submit.png')} />

          <Text style={styles.h1}>You recorded next activity!</Text>

          <View style={styles.window_section}>
            <View style={styles.couple}>
              <FontAwesomeIcon icon={faHourglassStart} size={20} style={{ color: '#FF474C' }} />
              <Text style={styles.column_text}>{start.slice(12, 20)}</Text>
            </View>

            <View style={styles.couple}>
              <FontAwesomeIcon icon={faHourglassEnd} size={20} style={{ color: '#FF474C' }} />
              <Text style={styles.column_text}>{end.slice(12, 20)}</Text>
            </View>
          </View>
          ...
          <View style={styles.window_section}>
            <View style={styles.column}>
              ...
              {dist < 1000 && <Text style={styles.column_text}>{dist.toFixed(2)} m</Text>}

              {dist >= 1000 && <Text style={styles.column_text}>{(dist / 1000).toFixed(2)} km</Text>}
            </View>
            ...
            <View style={styles.column}>
              ...
              <Text style={styles.column_text}>{speed(new Activity(0, start, end, dist)).toFixed(2)} km/h</Text>
            </View>
          </View>
          ...
          >
            <Text style={styles.btext}>Go to home</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Wrapper>
