...
export class QueueScreen extends HistoryIndexListenerScreen<Props, State> {
  ...
  constructor(props: Props) {
    ...
    this.state = {
      ...
      isLoadingMore: false,
      isRemoving: false,
      viewType: props.route.params.viewType || _queueKey,
    };
  }
  ...
  static navigationOptions = ({ navigation, route }) => {
    ...
    const allowViewTypeChange = route.params.allowViewTypeChange;
    ...
    return {
      ...
      headerTitle: allowViewTypeChange ? (
        <HeaderTitleSelector
          ...
          onValueChange={route.params._onViewTypeSelect}
          placeholder={headerTitleItemPlaceholder}
          selectedItemKey={route.params.viewType || route.params.viewType === false || _queueKey}
        />
      ) : (
        translate('Queue')
      ),
      headerRight: () => (
        <RNView style={[core.row]}>
          {route.params.viewType === _historyKey ? (
            <RNView>
              {!route.params.isEditing ? (
                <RNView style={styles.headerButtonWrapper}>
                  <NavHeaderButtonText
                    ...
                    color={textColor}
                    handlePress={route.params._startEditing}
                ...
                <RNView style={styles.headerButtonWrapper}>
                  <NavHeaderButtonText
                    ...
                    color={textColor}
                    handlePress={route.params._stopEditing}
                    style={styles.navHeaderTextButton}
