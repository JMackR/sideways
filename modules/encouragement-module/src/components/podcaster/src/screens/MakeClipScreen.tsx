...
export class MakeClipScreen extends React.Component<Props, State> {
  constructor(props: Props) {
    ...
    const initialPrivacy = this.props.route.params.initialPrivacy;
    const initialProgressValue = this.props.route.params.initialProgressValue;
    const isLoggedIn = this.props.route.params.isLoggedIn;
  ...
  render() {
    ...
    const { endTime, isLoggedIn, isPublicItemSelected, isSaving, progressValue, showHowToModal, startTime, title } =
      this.state;
