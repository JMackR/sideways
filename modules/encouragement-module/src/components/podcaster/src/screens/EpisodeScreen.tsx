...
export class EpisodeScreen extends HistoryIndexListenerScreen<Props, State> {
  constructor(props: Props) {
    ...
    const episodeId = episode?.id || this.props.route.params.episodeId;
    const includeGoToPodcast = this.props.route.params.includeGoToPodcast;
    const hasInternetConnection = this.props.route.params.hasInternetConnection;
