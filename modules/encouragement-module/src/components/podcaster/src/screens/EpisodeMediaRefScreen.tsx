...
export class EpisodeMediaRefScreen extends React.Component<Props, State> {
  ...
  constructor(props: Props) {
    super();
    const viewType = props.route.params.viewType || null;
    const flatListDataTotalCount = route.params.totalItems || 0;
    const existingData = props.route.params.initialData || [];
