...
export class PlaylistScreen extends HistoryIndexListenerScreen<Props, State> {
  constructor(props: Props) {
    ...
    const playlist = this.props.route.params.playlist;
    const playlistId = (playlist && playlist.id) || this.props.route.params.playlistId;
  ...
  static navigationOptions = ({ navigation, route }) => {
    ...
    const playlistTitle = route.params.playlistTitle || translate('Untitled Playlist');
  ...
  _initializePageData() {
    const playlistId = this.props.route.params.playlistId || this.state.playlistId;
  ...
  render() {
    ...
    const { isLoading, isLoadingMore, isSubscribed, isSubscribing, playlistId, selectedItem, showActionSheet } =
      this.state;
    const { screenPlaylist, session } = this.global;
    const playlist = screenPlaylist.playlist ? screenPlaylist.playlist : route.params.playlist;
