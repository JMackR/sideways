...
export class PlayerScreen extends React.Component<Props> {
  ...
  static navigationOptions = ({ navigation, route }) => {
    const _getEpisode = route.params._getEpisode;
    const _getMediaRef = route.params._getMediaRef;
    const _showShareActionSheet = route.params._showShareActionSheet;
    const _getInitialProgressValue = route.params._getInitialProgressValue;
  ...
  _handleShare = async (options: HandleShareParams) => {
    const { chapterId, customRSSEpisodeLink, customRSSPodcastLink, episodeId, isMusic, mediaRefId, podcastId } =
      options;
