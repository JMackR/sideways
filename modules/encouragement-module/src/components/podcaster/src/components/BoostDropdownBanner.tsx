...
import { StyleSheet, View, Platform, UIManager, ScrollView } from 'react-native';
    ...
    >
      ...
      <View style={styles.container}>
        ...
        {!!bannerInfo.errors?.length && (
          <PVIcon testID="boost_pay_banner_icon" name="exclamation-triangle" size={30} color={PV.Colors.redLighter} />
        )}
      </View>
    </DropdownBanner>
  );
