...
export class MiniPlayer extends React.PureComponent<Props> {
  render() {
    ...
    const podcastTitle = isMusic ? generateAuthorsText(nowPlayingItem.podcastAuthors) : nowPlayingItem?.podcastTitle;
      ...
      <View style={{ position: 'relative' }}>
        ...
        {!liveItem && (
          <View style={styles.progressWrapper}>
            <PlayerProgressBar backupDuration={backupDuration} globalTheme={globalTheme} onlySlider />
          </View>
        )}
