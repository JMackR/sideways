...
export const ImageFullView = () => {
  ...
  const GestureContentWrapper = gestureHandlerRootHOC(() => (
    <GestureDetector gesture={Gesture.Fling().direction(Directions.DOWN).onStart(dismissFullScreenImage)}>
      <GestureDetector gesture={Gesture.Fling().direction(Directions.RIGHT).onStart(dismissFullScreenImage)}>
