...
const betaMembershipRenewalBody =
  'Please provide us with the email address you have signed up for the Podverse free trial membership with (if it is different than the email you are writing us from right now).';
