...
export default function CommunitySearch() {
  ...
  const searchAccounts = (text: string = '') => {
    if (text.length > 2) {
      const unsubscribe = UserRepository.getUsers({ displayName: text, limit: 20, sortBy: 'displayName' }, (data) => {
        setUsersObject(data);
      });
      unsubscribe();
    }
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.headerWrap}>
        <View style={styles.inputWrap}>
          ...
          <TextInput style={styles.input} value={searchTerm} onChangeText={handleChange} />
      ...
      <CustomTab tabName={[TabName.Communities, TabName.Accounts]} onTabChange={handleTabChange} />
