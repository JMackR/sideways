...
export default function CreateCommunity() {
  ...
  const onCreateCommunity = useCallback(async () => {
    ...
    if (!uploadingImage) {
      ...
      const isPublic: boolean = selectedId === PrivacyState.private ? false : true;
  ...
  return (
    <ScrollView contentContainerStyle={styles.container} style={styles.container}>
      <View style={styles.uploadContainer}>
        {image ? <Image source={{ uri: image }} style={styles.image} /> : <View style={styles.defaultImage} />}
      ...
      <View style={styles.allInputContainer}>
        ...
        <View style={styles.inputContainer}>
          ...
          <Pressable onPress={() => setCategoryModal(true)} style={styles.categoryContainer}>
            <Text style={!categoryName ? styles.placeHolderText : [styles.categoryText]}>
        ...
        <View style={styles.radioGroup}>
          <Pressable onPress={() => setSelectedId(PrivacyState.public)} style={styles.listItem}>
            ...
            <RadioButton
              ...
              color={selectedId === PrivacyState.public ? theme.colors.primary : '#444'}
              size={17}
            />
          </Pressable>

          <Pressable onPress={() => setSelectedId(PrivacyState.private)} style={styles.listItem}>
            <View style={styles.avatar}>
        ...
        >
          ...
          {isCreating && uploadingImage && <ActivityIndicator style={styles.loading} animating={true} color={'#FFF'} />}
        </TouchableOpacity>
      </View>
