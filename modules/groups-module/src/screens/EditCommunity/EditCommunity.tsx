...
const EditCommunity = ({ navigation, route }) => {
  ...
  const onPressUpdateCommunity = useCallback(
    async ({ community_name, community_description }: { community_name: string; community_description: string }) => {
  ...
  useEffect(() => {
    navigation.setOptions({
      headerRight: () => {
        ...
        return (
          <TouchableOpacity disabled={loading} onPress={handleSubmit(onPressUpdateCommunity)}>
      ...
      <View>
        ...
        <View style={styles.allInputContainer}>
          <View style={styles.inputContainer}>
            <View style={styles.titleRow}>
              ...
              <Text style={styles.inputLengthMeasure}>
                {watch('community_name')
                  ? `${watch('community_name').length} / ${MAX_COMMUNITY_NAME_LENGTH}`
            ...
            />
            {errors.community_name && <Text style={styles.errorText}>{errors.community_name.message?.toString()}</Text>}
          </View>
            ...
            <View style={styles.titleRow}>
              ...
              <Text style={styles.inputLengthMeasure}>
                {watch('community_description')
                  ? `${watch('community_description').length} / ${MAX_ABOUT_TEXT_LENGTH}`
          ...
          <View style={styles.radioGroup}>
            <Pressable onPress={() => setisPublic(true)} style={styles.listItem}>
            ...
            <Pressable onPress={() => setisPublic(false)} style={styles.listItem}>
              <View style={styles.avatar}>
