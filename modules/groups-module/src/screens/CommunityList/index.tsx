...
export default function CommunityList({ navigation, route }: any) {
  ...
  const onPressCommunity = useCallback(
    ({ communityId, communityName }: { communityId: string; communityName: string }) => {
