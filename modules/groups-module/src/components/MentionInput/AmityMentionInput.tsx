...
const AmityMentionInput: FC<IMentionInput> = ({
  ...
  const { searchResult, getNextPage } = useSearch(currentSearchUserName, privateCommunityId);
  ...
  const renderSuggestions: FC<MentionSuggestionsProps> = useCallback(
    ...
    [getNextPage, onSelectUserMention, searchResult, styles.mentionListContainer],
  );
  return (
    <MentionTextInput
