...
const CreatePostChooseTargetModal = ({ visible, onClose, userId, onSelect, postType }: IModal) => {
      ...
      try {
        const unsubscribe = CommunityRepository.getCommunities(
          ...
          ({ data: communitiesList, onNextPage, hasNextPage, loading }) => {
            if (!loading) {
              setCommunities((prevCommunities: Amity.Community[]) => [...prevCommunities, ...communitiesList]);
