...
const ImageItem = ({
  ...
  const onScrollEndDrag = ({ nativeEvent }) => {
    ...
    const velocityY =
      ((_c =
        (_b = (_a = nativeEvent) === null || _a === void 0 ? void 0 : _a.velocity) === null || _b === void 0
          ? void 0
          : _b.y),
      _c !== null && _c !== void 0 ? _c : 0);
    const offsetY =
      ((_f =
        (_e = (_d = nativeEvent) === null || _d === void 0 ? void 0 : _d.contentOffset) === null || _e === void 0
          ? void 0
          : _e.y),
  ...
  const onScroll = ({ nativeEvent }) => {
    ...
    const offsetY =
      ((_c =
        (_b = (_a = nativeEvent) === null || _a === void 0 ? void 0 : _a.contentOffset) === null || _b === void 0
          ? void 0
          : _b.y),
      _c !== null && _c !== void 0 ? _c : 0);
