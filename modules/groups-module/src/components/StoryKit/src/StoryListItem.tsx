...
export const StoryListItem = ({
  ...
  useFocusEffect(
    React.useCallback(() => {
      const unsubscribe = StoryRepository.getStoryByStoryId(storyId, ({ error, loading, data }) => {
        if (error) return;
        if (!loading) {
      ...
      <View style={styles.flexCol}>
        ...
        <View style={[styles.userContainer, storyUserContainerStyle]}>
          <View style={styles.flexRowCenter}>
            <Image style={[styles.avatarImage, storyAvatarImageStyle]} source={{ uri: profileImage }} />
      ...
      {typeof renderSwipeUpComponent === 'function' ? (
        ...
        <View style={styles.footer}>
          ...
          <View style={styles.seenContainer}>
            ...
            <TouchableOpacity style={styles.iconContainer} onPress={onPressReaction}>
