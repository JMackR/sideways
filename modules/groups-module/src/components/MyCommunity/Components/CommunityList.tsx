...
import { communityIcon, officialIcon, privateIcon } from '../../../svg/svg-xml-list';
  ...
  return (
    ...
    >
      {item.avatarFileId && avatarUrl ? (
        ...
        <SvgXml style={styles.avatar} width={40} height={40} xml={communityIcon} />
      )}
      <View style={styles.textRow}>
        ...
        {item.isOfficial && <SvgXml width={20} height={20} xml={officialIcon(theme.colors.primary)} />}
      </View>
    </TouchableOpacity>
  );
};
