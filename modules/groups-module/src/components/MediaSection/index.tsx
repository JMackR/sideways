...
import ImageView from '../react-native-image-viewing/src';
...
const MediaSection: React.FC<IMediaSection> = ({ childrenPosts }) => {
  ...
  let imageStyle: StyleProp<ImageStyle> | StyleProp<ImageStyle>[] = styles.imageLargePost;
  ...
  return (
    <View>
      {pollIds.length > 0 ? <PollSection pollId={pollIds[0].pollId} /> : renderMediaPosts()}
      <ImageView
