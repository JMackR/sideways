...
export default function UserItem({
  ...
  }, [hideMenu, isCheckmark, onThreeDotTap, showThreeDot, styles.dotIcon, styles.threeDotsContainerStyle, user]);

  return (
    <TouchableOpacity style={styles.listItem} disabled={!onPress} onPress={handleToggle}>
