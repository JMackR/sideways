...
const RenderTextWithMention: React.FC<IrenderTextWithMention> = ({ mentionPositionArr, textPost }) => {
  ...
  const result: (string | JSX.Element)[][] = mentionPositionArr.map(({ index, length, userId }, i) => {
