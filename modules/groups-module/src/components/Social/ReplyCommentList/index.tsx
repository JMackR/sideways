...
import { expandIcon, likedXml, likeXml, personXml, threeDots } from '../../../svg/svg-xml-list';
...
export default function ReplyCommentList({ commentDetail, onDelete, commentId }: IReplyCommentList) {
  const {
    // commentId,
    data,
    user,
      ...
      <View style={styles.replyHeaderSection}>
        ...
        <View style={styles.rightSection}>
          ...
          <View style={styles.timeRow}>
            <Text style={styles.headerTextTime}>{getTimeDifference(createdAt)}</Text>
          ...
          <View style={styles.commentBubble}>
            {textComment && (
              <RenderTextWithMention textPost={textComment} mentionPositionArr={commentMentionPosition} />
            )}
