...
export default function AmityUiKitProvider({
  ...
  const isDarkTheme =
    configData?.preferred_theme === 'dark' || (configData?.preferred_theme === 'default' && colorScheme === 'dark');
  const themeColor = isDarkTheme ? configData.theme.dark : configData.theme.light;
