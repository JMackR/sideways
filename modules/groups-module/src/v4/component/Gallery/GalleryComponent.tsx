...
import ImageView from '../../../components/react-native-image-viewing/src';
...
const GalleryComponent = forwardRef(({ targetId, targetType }: IGalleryComponent, ref: React.Ref<FeedRefType>) => {
  ...
  return (
    <View style={styles.container}>
      <GalleryTab tabName={[TabName.Photos, TabName.Videos]} onTabChange={setTabName} curerntTab={tabName} />
      {renderGallery()}
      <ImageView
        images={mediaFiles}
