...
import React, { FC, useEffect, useState, useRef, useCallback, useMemo, memo } from 'react';
...
const CommentList: FC<ICommentListProp> = ({ postId, postType, disabledInteraction, onNavigate }) => {
