...
const MyStories = () => {
  ...
  const { getGlobalStoryTargets, globalStoryTargets, loading, globalStoryTargetsOnNextPage } = useGlobalStory();
  ...
  const onPressStoryView = useCallback(
    (storyTarget: Amity.StoryTarget) => {
      setViewStory(true);
      const currentIndex = globalStoryTargets.findIndex((target) => target.targetId === storyTarget.targetId);
        ...
        <View style={styles.container}>
          <FlatList
            ...
            renderItem={({ item: storyTarget }) => {
              return <StoryCircleItem onPressStoryView={onPressStoryView} storyTarget={storyTarget} />;
            }}
