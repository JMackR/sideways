import { ColorValue, FlatListProps, ImageStyle, TextStyle, ViewStyle } from 'react-native';
...
export type CircleListViewFlatListProps = Omit<FlatListProps<any>, 'renderItem' | 'data' | 'keyExtractor'>;
...
export type RenderCustomButton<T = Record<string, any>> = (props: CustomButtonRenderProps<T>) => React.ReactNode;
