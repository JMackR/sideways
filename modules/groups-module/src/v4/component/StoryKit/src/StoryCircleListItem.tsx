...
const StoryCircleListItem = ({ item, handleStoryItemPress, isCommunityStory = false }: StoryCircleListItemProps) => {
      ...
      <TouchableOpacity onPress={() => _handleItemPress(item)} style={styles.itemContainer}>
        <View>
          ...
          {item.isOfficial && !isCommunityStory && (
            <SvgXml style={styles.officialIcon} xml={officialIcon(theme.colors.primary)} />
          )}
        ...
        <View style={styles.textRow}>
          {!item.isPublic && <SvgXml width={17} height={17} xml={privateIcon(theme.colors.base)} />}
