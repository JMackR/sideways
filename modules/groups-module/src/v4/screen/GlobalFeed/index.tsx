...
import { deletePostById, getGlobalFeed, type IGlobalFeedRes } from '../../../providers/Social/feed-sdk';
...
export default function GlobalFeed() {
  ...
  const { updateGlobalFeed, deleteByPostId, clearFeed } = globalFeedSlice.actions;
  ...
  async function getGlobalFeedList(page: Amity.Page<number> = { after: 0, limit: 8 }): Promise<void> {
      ...
      <View style={styles.feedWrap}>
        <FlatList
          ...
          renderItem={({ item, index }) => (
            <PostList onDelete={onDeletePost} postDetail={item} postIndex={index} isGlobalfeed={true} />
          )}
          ...
          ListHeaderComponent={
            !refreshing && !isStoryExcluded && <AmityStoryTabComponent type={AmityStoryTabComponentEnum.globalFeed} />
          }
